...
static const NSUInteger kRadioButtonWidth=33;
...
-(void)defaultInit{
    ...
    [_button setImage:[UIImage imageNamed:@"cb_glossy_off@2x"] forState:UIControlStateNormal];
    [_button setImage:[UIImage imageNamed:@"cb_glossy_on@2x"] forState:UIControlStateSelected];

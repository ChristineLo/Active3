...
{
    if (title) {
        UITextView *titleView = [[UITextView alloc] initWithFrame:CGRectMake(34, 30, 700, 50)];
    ...
    if (content) {
        UITextView *textView = [[UITextView alloc] initWithFrame:CGRectMake(34, 100, 700, 700)];
